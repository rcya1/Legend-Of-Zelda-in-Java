...
public enum Tile
{
	...
	public static Tile parseID(int id)
	{
		...
		case 118:
			return GREEN_WATERFALL;
		case 119:
			return ORANGE_WATERFALL;
		case 120:
			return WHITE_WATERFALL;
	...
	public int toID()
	{
		...
		case GREEN_WATERFALL:
			return 118;
		case ORANGE_WATERFALL:
			return 119;
		case WHITE_WATERFALL:
			return 120;
	...
	public static BufferedImage getSprite(Tile tile)
	{
		...
		case GREEN_WATERFALL:
			return Images.Blocks.Green.WATERFALL;
		case ORANGE_WATERFALL:
			return Images.Blocks.Orange.WATERFALL;
		case WHITE_WATERFALL:
			return Images.Blocks.White.WATERFALL;
		}
		return null;
	}
